    ...
    const logs = [
        {
            ...
            level: "info",
            message: "开始备份任务: 系统文件夜间备份",
        },
        {
            time: "2024-01-15 23:00:05",
            level: "info",
            message: "扫描源目录: C:\\Windows\\System32",
        },
        {
            time: "2024-01-15 23:00:10",
            level: "info",
            message: "找到 1,247 个文件需要备份",
        },
        {
            time: "2024-01-15 23:02:15",
            level: "info",
            message: "开始传输文件: system.dll",
        },
        {
            time: "2024-01-15 23:02:45",
            level: "warning",
            message: "文件跳过: access_denied.sys (权限不足)",
        },
        {
            time: "2024-01-15 23:05:30",
            level: "info",
            message: "已完成 456/1247 个文件",
        },
        {
            time: "2024-01-15 23:08:12",
            level: "info",
            message: "当前速度: 12.5 MB/s",
        },
    ];
