  ...
  const renderCurrentPage = () => {
    switch (currentPage.page) {
      ...
      case 'settings':
        return <Settings />;
      case 'create-plan':
        return <CreatePlanWizard onBack={navigateBack} onComplete={navigateBack} />;
      case 'add-service':
        return <AddServiceWizard onBack={navigateBack} onComplete={navigateBack} />;
      case 'restore':
        return <RestoreWizard onBack={navigateBack} onComplete={navigateBack} data={currentPage.data} />;
      case 'edit-plan':
        return <EditPlanWizard onBack={navigateBack} onComplete={navigateBack} data={currentPage.data} />;
      case 'plan-details':
        return <PlanDetails onBack={navigateBack} onNavigate={navigateTo} data={currentPage.data} />;
      default:
        return <Dashboard onNavigate={navigateTo} />;
    }
  };

  const showSidebar = !['create-plan', 'add-service', 'restore', 'edit-plan', 'plan-details'].includes(currentPage.page);
